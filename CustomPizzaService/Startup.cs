...
namespace CustomPizzaService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ICustomPizzaRepo, CustomPizzaRepo>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "CustomPizzaService", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "CustomPizzaService v1"));
            }
