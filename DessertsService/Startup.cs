...
namespace DessertsService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IDessertsRepo, DessertsRepo>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "DessertsService", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "DessertsService v1"));
            }
